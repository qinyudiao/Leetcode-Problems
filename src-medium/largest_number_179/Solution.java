...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        int[][] testCases = {{10, 2}, {3, 30, 34, 5, 9}, {3, 33, 331, 30, 39}, {0, 0}, {824, 938, 1399, 5607, 6973, 5703, 9609, 4398, 8247},
                {121, 12}}; // 210, 9534330, 3933333130, 0, 9609938824824769735703560743981399, 12121
        for(int[] testCase : testCases) {
            System.out.println(solution.largestNumber(testCase));
        }
    }
    
    // Idea: Compare two integers by checking which concatenation of the them is
    // larger.
    ...
    public String largestNumber(int[] nums) {
        ...
        Arrays.sort(numStrs, (s1, s2) -> {
            return (s2 + s1).compareTo(s1 + s2); // no need for StringBuilder beacuse only one concatenation meaning that only
    ...
    // Runtime: 4 ms, faster than 98.32% of Java online submissions for Largest
    // Number.
    // Memory Usage: 38.1 MB, less than 99.31% of Java online submissions for
    // Largest Number.
    
    // Idea: Compare two integers by recursively comparing the remnant of the longer
    // string and the shorter string.
    ...
    // Runtime: 4 ms, faster than 98.32% of Java online submissions for Largest
    // Number.
    // Memory Usage: 38 MB, less than 99.38% of Java online submissions for Largest
    // Number.
}
