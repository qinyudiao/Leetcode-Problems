...
public class Solution {
    ...
    public boolean carPooling(int[][] trips, int capacity) {
        ...
        // Store the number of passengers getting in the car for each location in a
        // TreeMap (sorted by location).
        ...
        // Count the number of passengers in the car at each location, if larger than
        // the capacity, return false.
        int numPassengers = 0;
