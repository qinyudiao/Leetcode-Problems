...
//		    4   7
        ...
        Integer[][] testCasesBST = {{5, 3, 6, 2, 4, null, 7}, {5, 3, 6, 2, 4, null, 7}, {3, 1, 4, null, 2, null, null}, // [3, 1, 4, null, 2, null,
                                                                                                                        // null], 3 => [4, 1, null,
                                                                                                                        // null, 2, null, null]
    ...
    public TreeNode deleteNode(TreeNode root, int key) {
        if(root == null) // if root is null, return null
            return null;
        if(root.left == null && root.right == null) // if root has no children, return null is root is the key to delete, otherwise
                                                    // return root
    ...
    public void removeNode(TreeNode parent, TreeNode curr, boolean changeRoot, TreeNode rootParent) {
        ...
        // when the node to remove has two children, replace it with the next largest
        // node in the tree
