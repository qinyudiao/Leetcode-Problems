...
public class Solution {
    ...
    // Idea: use two HashMaps to save time from O(n) containsValue operation.
    ...
    // Runtime: 0 ms, faster than 100.00% of Java online submissions for Word
    // Pattern.
    // Memory Usage: 37.3 MB, less than 86.26% of Java online submissions for Word
    // Pattern.
    ...
    public boolean wordPattern1(String pattern, String str) {
        ...
        for(int i = 0; i < pattern.length(); i++) {
            ...
            else if(map.containsValue(words[i])) // containsValues() still takes O(1) because there are at most 26 values in the
                                                 // map.
                return false;
            else {
    ...
    // Runtime: 0 ms, faster than 100.00% of Java online submissions for Word
    // Pattern.
    // Memory Usage: 37.1 MB, less than 97.50% of Java online submissions for Word
    // Pattern.
}
