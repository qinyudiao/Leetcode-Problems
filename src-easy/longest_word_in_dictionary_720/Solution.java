...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        String[][] testCases = {{"a"}, {"w", "wo", "wor", "worl", "world"}, {"a", "banana", "app", "appl", "ap", "apply", "apple", "bb"},
                {"a", "cc", "zed", "banana", "ze", "app", "appl", "ap", "apply", "z", "zedddd", "apple", "bb", "ti", "worl", "wo", "wor", "w",
                        "world", "zeddd", "zedd"}}; // "a", world, apple, zeddddd
        for(String[] testCase : testCases) {
            System.out.println(solution.longestWord(testCase));
        }
    }
    
    // Use Trie to save time because we know all the words only contain lower case
    // letter.
    // O(n*m), where n is the number of words, m is the length of longestWord.
    // this one is faster on average because the average length of a word is very
    // small, plus that there are many words stored in the same trie path.
